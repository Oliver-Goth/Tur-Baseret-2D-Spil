...
namespace Tur_Baseret_2D_Spil.Classes.Creatures
{
    ...
    public class Goblin : Creature
    {
        ...
        public Goblin(Position position, int health, string name, List<WearableItem> carriedLoot, IGameLogging gameLogging) : base(position, name, health, carriedLoot, gameLogging)
        {
        }
